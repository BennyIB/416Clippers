...
public class OpportunityDistrictData extends MongoDocument {

    private List<Integer> x_points; 
    private List<Integer> y_points; 

    public OpportunityDistrictData(String id, String type, List<Integer> x_points, List<Integer> y_points) {
        super(id, type); 
